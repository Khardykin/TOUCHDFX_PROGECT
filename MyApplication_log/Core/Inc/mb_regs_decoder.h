...
#ifndef INC_MB_REGS_DECODER_H_
#define INC_MB_REGS_DECODER_H_
...
#define SETTINGS_GET_TYPE(SETTINGS) ((SETTINGS >> 0) & 0x3)
...
#define SETTINGS_SET_MULTIPLIER(SETTINGS, MULTIPLIER) (uint16_t) (SETTINGS &=~(0x3 << 2) ); (SETTINGS |= (MULTIPLIER << 2) )
#define SETTINGS_SET_TYPE(SETTINGS, TYPE) (uint16_t) (SETTINGS &=~(0x3 << 0) ); (SETTINGS |= (TYPE <<0) )
...
extern const char units_list[UNITS_SIZE][16];

#endif /* INC_MB_REGS_DECODER_H_ */
