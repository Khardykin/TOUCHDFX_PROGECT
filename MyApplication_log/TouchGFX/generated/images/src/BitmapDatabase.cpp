...
extern const unsigned char image_dark_backgrounds_main_bg_320x240px[]; // BITMAP_DARK_BACKGROUNDS_MAIN_BG_320X240PX_ID = 4, Size: 320x240 pixels
...
extern const unsigned char image_date_picker_background[]; // BITMAP_DATE_PICKER_BACKGROUND_ID = 6, Size: 600x220 pixels
extern const unsigned char image_date_picker_bar[]; // BITMAP_DATE_PICKER_BAR_ID = 7, Size: 584x80 pixels
extern const unsigned char image_date_picker_shadow_bottom[]; // BITMAP_DATE_PICKER_SHADOW_BOTTOM_ID = 8, Size: 584x40 pixels
extern const unsigned char image_date_picker_shadow_top[]; // BITMAP_DATE_PICKER_SHADOW_TOP_ID = 9, Size: 584x40 pixels
extern const unsigned char image_keyboard[]; // BITMAP_KEYBOARD_ID = 10, Size: 24x24 pixels
